...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "CHIMAERA Insight gali dirbti su daugeliu LLM tiekėjų. Ši paslauga bus atsakinga už pokalbių valdymą.",
    },
    userSetup: {
    ...
    survey: {
      title: "Sveiki atvykę į CHIMAERA Insight",
      description:
        "Padėkite mums pritaikyti CHIMAERA Insight jūsų poreikiams. Neprivaloma.",
      email: "Koks jūsų el. pašto adresas?",
      useCase: "Kam naudosite CHIMAERA Insight?",
      useCaseWork: "Darbui",
      useCasePersonal: "Asmeniniam naudojimui",
      useCaseOther: "Kita",
      comment: "Kaip sužinojote apie CHIMAERA Insight?",
      commentPlaceholder:
  ...
  settings: {
    ...
    "mobile-app": "CHIMAERA Insight mobiliesiems",
    channels: "Kanalai",
    "available-channels": {
      telegram: "„Telegram“",
    },
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Įjunkite neribotą kiekį įrankių ir sumažinkite žetonų (tokens) naudojimą iki 80 % vienai užklausai — CHIMAERA Insight automatiškai parinks tinkamus įgūdžiai kiekvienai užklausai.",
        "max-tools": {
  ...
  customization: {
    interface: {
      ...
      description: "Nustatykite savo CHIMAERA Insight sąsajos nustatymus.",
    },
    branding: {
      title: "Prekės ženklas",
      description:
        "Pritaikykite savo CHIMAERA Insight instanciją naudodami savo prekės ženklą.",
    },
    chat: {
      title: "Pokalbiai",
      description: "Nustatykite savo CHIMAERA Insight pokalbių nustatymus.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Rodymo kalba",
        description:
          "Pasirinkite pageidaujamą CHIMAERA Insight sąsajos kalbą (jei yra vertimai).",
      },
      logo: {
  ...
  api: {
    title: "API raktai",
    description:
      "API raktai leidžia programiškai pasiekti ir valdyti šią CHIMAERA Insight instanciją.",
    ...
    modal: {
      ...
      helper:
        "Sukūrus API raktą, jį galima naudoti programiškai pasiekti ir konfigūruoti šį CHIMAERA Insight egzempliorių.",
      name: {
        label: "Pavadinimas",
  ...
  llm: {
    title: "LLM pasirinkimas",
    description:
      "Tai jūsų pasirinkto LLM pokalbių ir vektorių kūrimo tiekėjo duomenys ir nustatymai. Svarbu, kad šie raktai būtų aktualūs ir teisingi, kitaip CHIMAERA Insight neveiks tinkamai.",
  ...
  transcription: {
    ...
    "warn-start":
      "Naudojant vietinį Whisper modelį įrenginiuose su ribotu RAM ar CPU kiekiu, CHIMAERA Insight gali sulėtėti apdorojant medijos failus.",
  ...
  embedding: {
    ...
    "desc-end":
      "Vektorių kūrimas (embedding) yra procesas, paverčiantis tekstą skaitmeniniais vektoriais. Šie duomenys reikalingi norint paversti jūsų failus ir užklausas į formatą, kurį CHIMAERA Insight gali apdoroti.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Tai nustatymai, kaip veiks jūsų CHIMAERA Insight instancija. Svarbu, kad šie duomenys būtų aktualūs ir teisingi.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Apsaugokite savo CHIMAERA Insight instanciją slaptažodžiu. Jei jį pamiršite, atkūrimo būdo nėra, todėl būtinai jį išsisaugokite.",
  ...
  privacy: {
    ...
    description:
      "Tai jūsų konfigūracija, kaip prijungti trečiųjų šalių tiekėjai ir CHIMAERA Insight tvarko jūsų duomenis.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Šie failai bus įkelti į dokumentų procesorių, veikiantį šioje CHIMAERA Insight instancijoje. Šie failai nėra siunčiami ar bendrinami su trečiosiomis šalimis.",
    },
    pinning: {
      what_pinning: "Kas yra dokumento prisegimas?",
      pin_explained_block1:
        "Kai <b>prisegate</b> dokumentą CHIMAERA Insight sistemoje, mes įtrauksime visą dokumento turinį į jūsų užklausos langą, kad jūsų LLM jį visiškai suprastų.",
      pin_explained_block2:
        "Tai geriausiai veikia su <b>didelio konteksto modeliais</b> arba mažais failais, kurie yra labai svarbūs žinių bazei.",
      pin_explained_block3:
        "Jei pagal numatytuosius nustatymus negaunate pageidaujamų atsakymų iš CHIMAERA Insight, prisegimas yra puikus būdas gauti aukštesnės kokybės atsakymus vienu spustelėjimu.",
      accept: "Gerai, supratau",
    },
    watching: {
      what_watching: "Ką daro dokumento stebėjimas?",
      watch_explained_block1:
        "Kai <b>stebite</b> dokumentą CHIMAERA Insight sistemoje, mes <i>automatiškai</i> sinchronizuosime jūsų dokumento turinį iš originalaus šaltinio reguliariais intervalais. Tai automatiškai atnaujins turinį kiekvienoje darbo srityje, kurioje šis failas yra valdomas.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Atmintis",
        placeholder:
          "Pavyzdžiui, vartotojo vardas yra Joe, vartotojas dirba „CHIMAERA Insight“ sistemoje ir pan.",
        create: "Sukurti",
        save: "Įrašyti",
        cancel: "Atšaukti",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Prieš skelbdami elementus, turite prisijungti prie CHIMAERA Insight bendruomenės centro.",
  ...
  telegram: {
    ...
    description:
      "Prisijunkite savo „CHIMAERA Insight“ instanciją prie „Telegram“, kad galėtumėte kalbėti su savo darbo vietomis iš bet kurio įrenginio.",
    setup: {
      step1: {
