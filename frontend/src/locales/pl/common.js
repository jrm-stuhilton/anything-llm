...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "CHIMAERA Insight może współpracować z wieloma dostawcami modeli językowych",
    },
    userSetup: {
    ...
    survey: {
      title: "Witamy w CHIMAERA Insight",
      description:
        "Pomóż nam stworzyć CHIMAERA Insight dostosowany do Twoich potrzeb. Opcjonalnie.",
      email: "Jaki jest Twój adres e-mail?",
      useCase: "Do czego będziesz używać CHIMAERA Insight?",
      useCaseWork: "Do pracy",
      useCasePersonal: "Do użytku osobistego",
      useCaseOther: "Inne",
      comment: "Skąd dowiedziałeś się o CHIMAERA Insight?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      heading: "Wyjaśnij mi",
      body: "Korzyści z CHIMAERA Insight",
    },
    delete: {
  ...
  customization: {
    interface: {
      ...
      description: "Ustaw preferencje interfejsu użytkownika dla CHIMAERA Insight.",
    },
    branding: {
      title: "Branding i white-labeling",
      description:
        "Oznakuj swoją instancję CHIMAERA Insight niestandardowym brandingiem.",
    },
    chat: {
      title: "Czat",
      description: "Ustaw preferencje czatu dla CHIMAERA Insight.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Język",
        description:
          "Wybierz preferowany język interfejsu użytkownika CHIMAERA Insight - jeśli dostępne są tłumaczenia.",
      },
      logo: {
        title: "Logo",
        description:
  ...
  api: {
    title: "Klucze API",
    description:
      "Klucze API umożliwiają dostęp do instancji CHIMAERA Insight i zarządzanie nią.",
    ...
    modal: {
      ...
      helper:
        "Po utworzeniu klucz API może być używany do programowego dostępu do tej instancji CHIMAERA Insight i jej konfiguracji.",
      name: {
        label: "Nazwa",
  ...
  llm: {
    ...
    description:
      "Tutaj skonfigurujesz dostawcę modeli językowych używanych do czatów i embeddingów. Upewnij się, że wszystkie klucze są aktualne i poprawne - bez tego CHIMAERA Insight nie będzie działać.",
  ...
  transcription: {
    ...
    "warn-start":
      "Korzystanie z lokalnego modelu Whisper na komputerach z ograniczoną pamięcią RAM lub procesorem może spowodować przerwanie pracy CHIMAERA Insight podczas przetwarzania plików multimedialnych.",
    "warn-recommend":
  ...
  vector: {
    ...
    description:
      "Tutaj skonfigurujesz wektorową bazę danych dla CHIMAERA Insight. Upewnij się, że wszystkie ustawienia są poprawne.",
    provider: {
      title: "Wektorowa baza danych",
  ...
  privacy: {
    ...
    description:
      "Jest to konfiguracja sposobu, w jaki połączeni dostawcy zewnętrzni i CHIMAERA Insight przetwarzają dane użytkownika.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Pliki zostaną przetworzone w obrębie danej instancji CHIMAERA Insight. Pliki te nie będą udostępniane innym podmiotom.",
    },
    pinning: {
      what_pinning: "Czym jest przypinanie dokumentów?",
      pin_explained_block1:
        "Kiedy <b>przypinasz</b> dokument w CHIMAERA Insight, dodamy całą zawartość dokumentu do okna promptu, aby LLM mógł w pełni zrozumieć jego treść.",
      ...
      pin_explained_block3:
        "Jeśli domyślnie nie otrzymujesz pożądanych odpowiedzi z CHIMAERA Insight, przypinanie jest świetnym sposobem na uzyskanie wyższej jakości odpowiedzi za jednym kliknięciem.",
      accept: "Ok, rozumiem",
    },
    watching: {
      what_watching: "Do czego służy oglądanie dokumentu?",
      watch_explained_block1:
        "Podczas <b>obserwowania</b> dokumentu w CHIMAERA Insight będziemy <i>automatycznie</i> synchronizować zawartość dokumentu z jego oryginalnym źródłem w regularnych odstępach czasu. Spowoduje to automatyczną aktualizację zawartości w każdym obszarze roboczym, w którym ten plik jest zarządzany.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Pamięć",
        placeholder:
          "np. Imię użytkownika to Joe, użytkownik pracuje w firmie CHIMAERA Insight, itp.",
        create: "Stwórz",
        save: "Zapisz",
        cancel: "Anuluj",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Przed opublikowaniem elementów należy uwierzytelnić się w centrum społeczności CHIMAERA Insight.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Chroń swoją instancję CHIMAERA Insight hasłem. Jeśli go zapomnisz, nie ma metody odzyskiwania, więc upewnij się, że zapisałeś to hasło.",
  ...
  telegram: {
    ...
    description:
      "Połącz swoją instancję CHIMAERA Insight z Telegramem, aby móc rozmawiać z przestrzeniami roboczymi z dowolnego urządzenia.",
    setup: {
      step1: {
