...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "CHIMAERA Insight funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao CHIMAERA Insight",
      description: "Ajude-nos a melhorar o CHIMAERA Insight. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o CHIMAERA Insight?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o CHIMAERA Insight?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do CHIMAERA Insight",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Permita o uso ilimitado de ferramentas e reduza o consumo de tokens em até 80% por consulta — O CHIMAERA Insight seleciona automaticamente as habilidades mais adequadas para cada solicitação.",
        "max-tools": {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do CHIMAERA Insight com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  api: {
    ...
    modal: {
      ...
      helper:
        "Depois de criada, a chave de API pode ser usada para acessar e configurar esta instância do CHIMAERA Insight programaticamente.",
      name: {
        label: "Nome",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o CHIMAERA Insight.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o CHIMAERA Insight lidam com seus dados.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do CHIMAERA Insight. Não são compartilhados com terceiros.",
    },
    pinning: {
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memória",
        placeholder:
          "por exemplo, o nome do usuário é Joe, o usuário trabalha com CHIMAERA Insight, etc.",
        create: "Criar",
        save: "Salvar",
        cancel: "Cancelar",
      },
  ...
  telegram: {
    ...
    description:
      "Conecte sua instância do CHIMAERA Insight ao Telegram para que possa conversar com seus espaços de trabalho a partir de qualquer dispositivo.",
    setup: {
      step1: {
