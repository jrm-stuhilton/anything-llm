...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "CHIMAERA Insight ist mit vielen LLM-Anbietern kompatibel. Der ausgewählte Dienst wird für die Chats verwendet.",
    },
    userSetup: {
    ...
    survey: {
      title: "Willkommen bei CHIMAERA Insight",
      description:
        "Helfen Sie uns, CHIMAERA Insight an Ihre Bedürfnisse anzupassen. (Optional)",
      email: "Wie lautet Ihre E-Mail-Adresse?",
      useCase: "Wofür möchten Sie CHIMAERA Insight verwenden?",
      useCaseWork: "Beruflich",
      useCasePersonal: "Privat",
      useCaseOther: "Sonstiges",
      comment: "Wie haben Sie von CHIMAERA Insight erfahren?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      heading: "Erkläre mir",
      body: "die Vorteile von CHIMAERA Insight",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Ermöglichen Sie die uneingeschränkte Nutzung von Werkzeugen und reduzieren Sie die Token-Nutzung pro Anfrage um bis zu 80 % – CHIMAERA Insight wählt automatisch die passenden Fähigkeiten für jede Anfrage aus.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Passen Sie die Benutzeroberfläche von CHIMAERA Insight an.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "Individualisieren Sie Ihre CHIMAERA Insight-Instanz durch eigenes Branding.",
    },
    chat: {
      title: "Chat",
      description: "Passen Sie Ihre Chat-Einstellungen für CHIMAERA Insight an.",
      auto_submit: {
  ...
  api: {
    title: "API-Schlüssel",
    description:
      "API-Schlüssel ermöglichen es dem Besitzer, programmatisch auf diese CHIMAERA Insight-Instanz zuzugreifen und sie zu verwalten.",
    ...
    modal: {
      ...
      helper:
        "Nach der Erstellung kann der API-Schlüssel verwendet werden, um programmgesteuert auf diese CHIMAERA Insight-Instanz zuzugreifen und sie zu konfigurieren.",
      name: {
        label: "Name",
  ...
  llm: {
    title: "LLM-Präferenz",
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für Ihren bevorzugten LLM-Chat- und Einbettungsanbieter. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind, sonst wird CHIMAERA Insight nicht richtig funktionieren.",
  ...
  transcription: {
    ...
    "warn-start":
      "Die Verwendung des lokalen Whisper-Modells auf Maschinen mit begrenztem RAM oder CPU kann CHIMAERA Insight bei der Verarbeitung von Mediendateien zum Stillstand bringen.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Einbettung ist der Prozess, Text in Vektoren umzuwandeln. Diese Anmeldeinformationen sind erforderlich, um Ihre Dateien und Prompts in ein Format umzuwandeln, das CHIMAERA Insight zur Verarbeitung verwenden kann.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für die Funktionsweise Ihrer CHIMAERA Insight-Instanz. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dies ist Ihre Konfiguration dafür, wie verbundene Drittanbieter und CHIMAERA Insight Ihre Daten behandeln.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Diese Dateien werden zum Dokumentenprozessor hochgeladen, der auf dieser CHIMAERA Insight-Instanz läuft. Diese Dateien werden nicht an Dritte gesendet oder geteilt.",
    },
    pinning: {
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Gedächtnis",
        placeholder:
          "z.B. Benutzername: Joe, Benutzer arbeitet an CHIMAERA Insight, usw.",
        create: "Erstellen",
        save: "Speichern",
        cancel: "Abbrechen",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Sie müssen sich vor der Veröffentlichung von Inhalten über den CHIMAERA Insight Community Hub authentifizieren.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Schützen Sie Ihre CHIMAERA Insight-Instanz mit einem Passwort. Wenn Sie dieses vergessen, gibt es keine Wiederherstellungsmethode, also stellen Sie sicher, dass Sie dieses Passwort speichern.",
