...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "CHIMAERA Insight töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      title: "Tere tulemast CHIMAERA Insight-i",
      description:
        "Aita meil CHIMAERA Insight sinu vajadustele vastavaks kujundada. Valikuline.",
      email: "Mis on su e-post?",
      useCase: "Milleks kasutad CHIMAERA Insight-i?",
      useCaseWork: "Töö jaoks",
      useCasePersonal: "Isiklikuks kasutuseks",
      useCaseOther: "Muu",
      comment: "Kust kuulsid CHIMAERA Insight-ist?",
      commentPlaceholder:
  ...
  settings: {
    ...
    "mobile-app": "CHIMAERA Insight mobiilversioon",
    "community-hub": {
  ...
  general: {
    ...
    message: {
      ...
      body: "CHIMAERA Insight eeliseid",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Lubage piiramatu hulga tööriistade kasutamist ning vähendage küsimuse kohta kasutatavate tokenide arv kuni 80% – CHIMAERA Insight valib automaatselt iga küsimuse jaoks sobivad oskused.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Sea CHIMAERA Insight-i UI eelistused.",
    },
    branding: {
      title: "Bränding ja valgesildistamine",
      description: "Valgesildista oma CHIMAERA Insight kohandatud brändinguga.",
    },
    chat: {
      title: "Vestlus",
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles CHIMAERA Insight UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda CHIMAERA Insight instantsi.",
    ...
    modal: {
      ...
      create: "Loo API võti",
      helper:
        "Pärast loomist saab API võtit kasutada sellele CHIMAERA Insight-i instantsile programmiga ligi pääsemiseks ja selle seadistamiseks.",
      name: {
        label: "Nimi",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul CHIMAERA Insight ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et CHIMAERA Insight saaks sinu failid ja päringud töödelda.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas CHIMAERA Insight töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Konfiguratsioon kolmandate osapoolte ja CHIMAERA Insight-i andmekäitluse kohta.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Mälestus",
        placeholder:
          "Näiteks kasutaja nimi on Joe, kasutaja töötab ettevõttes CHIMAERA Insight jne.",
        create: "Loo",
        save: "Salvesta",
        cancel: "Katkuda\nTühista",
      },
  ...
  telegram: {
    title: "Telegrami bot",
    description:
      "Ühendage oma CHIMAERA Insight instants Telegramiga, et saaksite vestleda oma tööruumidega igast seadmist.",
    setup: {
      step1: {
