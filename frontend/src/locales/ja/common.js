...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLMの設定",
      description:
        "CHIMAERA Insightは多くのLLMプロバイダーと連携できます。これがチャットを処理するサービスになります。",
    },
    userSetup: {
      title: "ユーザー設定",
    ...
    survey: {
      title: "CHIMAERA Insightへようこそ",
      description:
        "CHIMAERA Insightをあなたのニーズに合わせて構築するためにご協力ください。任意です。",
      email: "メールアドレスは何ですか？",
      useCase: "CHIMAERA Insightを何に使用しますか？",
      useCaseWork: "仕事用",
      useCasePersonal: "個人用",
      useCaseOther: "その他",
      comment: "CHIMAERA Insightをどのように知りましたか？",
      commentPlaceholder:
  ...
  settings: {
    ...
    chat: "チャット",
    "mobile-app": "CHIMAERA Insight モバイル版",
    "community-hub": {
      title: "地域交流拠点",
      trending: "人気のあるものを探す",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        title: "知的なスキル選択",
        description:
          "クエリごとに、無制限のツールを使用し、トークン使用量を最大80%削減できます。CHIMAERA Insightは、各プロンプトに対して最適なスキルを自動的に選択します。",
        "max-tools": {
          title: "マックスツールズ",
          description:
  ...
  api: {
    title: "APIキー",
    description:
      "APIキーにより、プログラム経由でこのCHIMAERA Insightインスタンスにアクセスおよび管理できます。",
    link: "APIドキュメントを読む",
    ...
    modal: {
      ...
      create: "APIキーを作成",
      helper:
        "作成したAPIキーは、このCHIMAERA Insightインスタンスにプログラムからアクセスして設定するために使用できます。",
      name: {
        label: "名前",
        placeholder: "本番環境の統合",
  ...
  llm: {
    title: "LLMの設定",
    description:
      "これは、お好みのLLMチャットおよび埋め込みプロバイダー用の認証情報と設定です。これらのキーが最新かつ正確でない場合、CHIMAERA Insightは正しく動作しません。",
    provider: "LLMプロバイダー",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    "warn-start":
      "RAMやCPUが限られたマシンでローカルのWhisperモデルを使用すると、メディアファイルの処理中にCHIMAERA Insightが停止する可能性があります。",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "埋め込みとは、テキストをベクトルに変換するプロセスです。これらの認証情報は、ファイルやプロンプトをCHIMAERA Insightが処理できるフォーマットに変換するために必要です。",
    provider: {
      title: "埋め込みプロバイダー",
    },
  },
  ...
  vector: {
    title: "ベクターデータベース設定",
    description:
      "これは、CHIMAERA Insightインスタンスの動作方法用の認証情報と設定です。これらのキーが最新で正確であることが重要です。",
    provider: {
  ...
  privacy: {
    title: "プライバシーとデータ処理",
    description:
      "これは、接続されているサードパーティプロバイダーとCHIMAERA Insightがデータをどのように処理するかの設定です。",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "これらのファイルは、このCHIMAERA Insightインスタンス上のドキュメント処理機能にアップロードされます。第三者に送信・共有されることはありません。",
    },
    pinning: {
      what_pinning: "ドキュメントのピン留めとは？",
      pin_explained_block1:
        "CHIMAERA Insightでドキュメントを<b>ピン留め</b>すると、その内容全体がプロンプトウィンドウに挿入され、LLMがしっかり理解できるようになります。",
    ...
    watching: {
      ...
      watch_explained_block1:
        "CHIMAERA Insightでドキュメントを<b>ウォッチ</b>すると、元のソースから定期的に内容が<i>自動的に</i>同期されます。管理しているすべてのワークスペースで内容が自動更新されます。",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "記憶",
        placeholder:
          "例：ユーザー名がジョー、ユーザーが使用しているツールがCHIMAERA Insightなど。",
        create: "作成する",
        save: "保存",
        cancel: "キャンセル",
      },
  ...
  customization: {
    interface: {
      title: "UI設定",
      description: "CHIMAERA Insight の UI 設定を調整してください。",
    },
    branding: {
      title: "ブランディングとホワイトレーベル化",
      description:
        "CHIMAERA Insightインスタンスを、独自のブランドでカスタマイズしてください。",
    },
    chat: {
      title: "チャット",
      description: "CHIMAERA Insight のチャット設定をカスタマイズしてください。",
      auto_submit: {
        title: "自動音声入力送信",
    ...
    items: {
      ...
      "display-language": {
        title: "表示言語",
        description:
          "CHIMAERA InsightのUIを特定の言語で表示するためのオプションを選択してください。翻訳が利用可能な場合にのみ有効です。",
      },
      logo: {
        title: "ブランドロゴ",
        description:
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "本人確認が必要です。",
          description:
            "アイテムを公開する前に、CHIMAERA Insightコミュニティハブで認証する必要があります。",
          button: "コミュニティハブへの接続",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      title: "パスワード保護",
      description:
        "CHIMAERA Insightインスタンスをパスワードで保護します。これを忘れた場合、回復方法はないため、このパスワードを必ず保存してください。",
